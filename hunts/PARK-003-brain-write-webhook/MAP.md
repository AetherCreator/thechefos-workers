...
Goal: A webhook endpoint at thechefos.com/api/brain/push that accepts a brain node payload and commits it to SuperClaude/brain/ via GitHub API. No desktop. No token management. Any app can push a brain node.
