...
// Playtester endpoints (v0.7.0) — brain-write owns full /api/playtester/* path
app.all('/api/playtester/*', (c) => c.env.BRAIN_WRITE.fetch(c.req.raw))
