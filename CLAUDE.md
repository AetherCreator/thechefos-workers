# TheChefOS Workers ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Claude Code Context
...
Owner: Tyler Vegetabile ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ iPhone-only workflow, Claude Max.

## Deployed Workers (7 live as of 2026-03-28)
| Worker | Package | Purpose |
|--------|---------|---------|
| thechefos-router | packages/router | Hono router ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ CORS, service binding dispatch |
...
## Router Dispatch Map
```
/oauth/*        ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ OAUTH_SERVER (service binding)
/api/brain/*    ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ BRAIN_WRITE (service binding)
/api/mcp*       ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ MCP_SERVER (service binding)
/api/telegram*  ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ TELEGRAM_BOT (service binding)
/api/claude     ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ AI_GATEWAY (service binding)
/ai/*           ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ AI_GATEWAY (service binding)
```
...
3. Downstream Workers receive full paths ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ use forward() helper to strip prefix
4. Workers service bindings require bound Worker to be deployed FIRST
5. Kid-safety: x-product header (superconci/morewords) ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ cf-aig-collect-log-payload: false
...
1. Cloudflare:workers_list ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ deployed Workers
2. Cloudflare:d1_databases_list ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ D1 databases
3. Cloudflare:kv_namespaces_list ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ KV stores
...
## Related Repos
- SuperClaude (github.com/AetherCreator/SuperClaude) ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ skills, brain/, state files
- ChefOS (github.com/AetherCreator/chefos) ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ React PWA frontend
- SuperConci (github.com/AetherCreator/SuperConci) ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Kids learning PWA
- More (github.com/AetherCreator/more) ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ MoreWords vocab app

<!-- COGNITIVE-CACHE-START -->
## 🧠 Tyler's Cognitive Context (auto-generated 2026-04-12)
